...
df$george_veross  <- apply(df, MARGIN = 1, function(x){verossim(theta=x["theta"], vetor_resp=george, bs=bs)})
...
* A função de maxima verossimilhança!
* Derivadas: https://www.desmos.com/calculator/p6zuigdaqf


```{r}

df %>% pivot_longer(cols = 2:3, names_to = "pessoa", values_to = "veross") %>%
